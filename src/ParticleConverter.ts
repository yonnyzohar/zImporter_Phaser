export class ParticleConverter {
    ...
    private static processBehavior(behavior: any, phaserConfig: any): void {
    ...
    private static processAlphaBehavior(config: any, phaserConfig: any): void {
        if (config.alpha?.list && config.alpha.list.length >= 2) {
            const list = config.alpha.list;
            const start = list.find((item: any) => item.time === 0) || list[0];
            const end = list.find((item: any) => item.time === 1) || list[list.length - 1];
    ...
    private static processScaleBehavior(config: any, phaserConfig: any): void {
    ...
    private static processColorBehavior(config: any, phaserConfig: any): void {
    ...
    private static processMoveSpeedBehavior(config: any, phaserConfig: any): void {
    ...
    private static processRotationStaticBehavior(config: any, phaserConfig: any): void {
    ...
    private static processSpawnBurstBehavior(config: any, phaserConfig: any): void {
